...
def main():
    ...
    page_limit = 4  # Set the number of pages to scrape (you can adjust this)
    for page in range(page_limit):
        ...
        next_button = WebDriverWait(driver, 10).until(
            EC.element_to_be_clickable((By.XPATH, "//div[@class='d-table-container'][@data-table='alpha']//button[@id='next']"))
        )
    ...
    df.to_csv("acres_burned.csv", index=False)
